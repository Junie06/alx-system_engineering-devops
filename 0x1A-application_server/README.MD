...
```bash
(venv) ubuntu@441009-web-01:~/AirBnB_clone_v2$ python3 -m web_flask.0-hello_route
...
```bash
ubuntu@441009-web-01:~$ curl localhost:5000/airbnb_onepage
Hello HBNB!ubuntu@441009-web-01:~$
```
